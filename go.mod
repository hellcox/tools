...
require (
	...
	github.com/leaanthony/idgen v1.0.0 // indirect
...
// replace github.com/wailsapp/wails/v2 v2.0.0-beta.43 => E:\develop\project-go\gopath\pkg\mod\github.com\wailsapp\wails\v2@v2.0.0-beta.43
